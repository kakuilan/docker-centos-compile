...
# nginx相关包
ARG NGBUILD_VER=0.11.10
ARG ZLIB_VER=1.2.11
ARG PCRE_VER=8.44
ARG OPENSSL_VER=1.1.1h
ARG OPENRESTY_VER=1.17.8.2
ARG LUAROCKS_VERSION=3.4.0
ARG IMAGEMAGICK_VERSION=7.0.10-30
ARG IMAGEMAGICK6_VERSION=6.9.11-22
...
ARG PHP_GRPC_VER=1.32.0
ARG PHP_IMAGICK_VER=3.4.4
ARG PHP_INOTIFY_VER=2.0.0
ARG PHP_MCRYPT_VER=1.0.3
ARG PHP_MEMCACHED_VER=3.1.5
ARG PHP_MONGODB_VER=1.8.0
ARG PHP_MSGPACK_VER=2.1.1
ARG PHP_NSQ_VER=3.5.0
ARG PHP_PROTOBUF_VER=3.13.0
ARG PHP_REDIS_VER=5.3.1
ARG PHP_SWOOLE_VER=4.5.4
ARG PHP_XDEBUG_VER=2.9.7
ARG PHP_XHPROF_VER=2.2.0
