...
# install packaging tools
    && set -o pipefail && curl -sL https://rpm.nodesource.com/setup_12.x | sudo -E bash - \
    && set -o pipefail && curl -sL https://dl.yarnpkg.com/rpm/yarn.repo | sudo tee /etc/yum.repos.d/yarn.repo \
